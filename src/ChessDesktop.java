...
JOptionPane.showMessageDialog(window,
    ChessMainFrame.getString("wonA"),
    ChessMainFrame.getString("wonB"),
    JOptionPane.WARNING_MESSAGE);
	}

	public void programWon(){
JOptionPane.showMessageDialog(window,
    ChessMainFrame.getString("lostA"),
    ChessMainFrame.getString("lostB"),
    JOptionPane.ERROR_MESSAGE);
	}
	
	public void staleMate(){
            JOptionPane.showMessageDialog(window,
                        ChessMainFrame.getString("stalemateA"),
                        ChessMainFrame.getString("stalemateB"),
                        JOptionPane.ERROR_MESSAGE);
	}
...
/*soon to go away*/	public void edit(ChessPosition p){}
	...
	public ImageIcon pp(int piece) {
            ...
            switch (piece) {
                case -ChessPosition.  KING: return blackKing;
                case -ChessPosition. QUEEN: return blackQueen;
                case -ChessPosition.BISHOP: return blackBishop;
                case -ChessPosition.KNIGHT: return blackKnight;
                case -ChessPosition.  ROOK: return blackRook;
                case -ChessPosition.  PAWN: return blackPawn;
                case  ChessPosition.  PAWN: return whitePawn;
                case  ChessPosition.  ROOK: return whiteRook;
                case  ChessPosition.KNIGHT: return whiteKnight;
                case  ChessPosition.BISHOP: return whiteBishop;
                case  ChessPosition. QUEEN: return whiteQueen;
                case  ChessPosition.  KING: return whiteKing;
                default: return null;
            }
	}	
	...
	private void buildGraphics(){
            ...
            String f = ChessMainFrame.getString("imagesPath"), s = "/", e = ".png", c, 
                            p = "pawn", r = "rook", n = "knight", b = "bishop", q = "queen", k = "king";

/*            c = "white";
            whitePawn	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + p + e));
            whiteRook	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + r + e));
            whiteKnight	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + n + e));
            whiteBishop	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + b + e));
            whiteQueen	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + q + e));
            whiteKing	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + k + e));

            c = "black";
            blackPawn	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + p + e));
            blackRook	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + r + e));
            blackKnight	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + n + e));
            blackBishop	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + b + e));
            blackQueen	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + q + e));
            blackKing	= new ImageIcon(ChessDesktop.class.getResource(f + s + c + s + k + e));*/
    ...
    protected static ImageIcon createImageIcon(String path) {
        ...
        BufferedInputStream imgStream = new BufferedInputStream(
           ChessDesktop.class.getResourceAsStream(path));
        if (imgStream != null) {
