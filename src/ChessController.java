...
public class ChessController {
    ...
    private Chess chess;
    private ChessPosition currentPosition, lastPosition;
    ...
    /*
     * Main control structure. Currently called by desktop's
     * ChessMovementInternalFrame actionListener.
     * 
     */
    ...
    public void newGame() {
        ...
        if (TESTBOARD) {
            for (int i = 0; i < 120; i++)
                currentPosition.board[i] = testBoard[i];
        } else {
            for (int i = 0; i < 120; i++)
                currentPosition.board[i] = Chess.initialBoard[i];
        }
        ...
        int n = JOptionPane.showOptionDialog(owner, f, t, JOptionPane.YES_NO_CANCEL_OPTION,
                JOptionPane.QUESTION_MESSAGE, null, /* don't use a custom Icon */ options,
    ...
    /*
     * Save and load functions. Saves currentPossition to *.chess, or loads *.chess
     * to currentPosition. *.chess is a Serialized ChessPosition
     */
    public void save() {
        if (fileChooser == null) {
            createFileChooser();
    ...
    // Test methods
    /*
     * private static int[] testBoard = { 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7,
     * 7, 7, 7, 7, 7, 7, 7, 7, ChessPosition.BLANK, ChessPosition.PAWN,
     * ChessPosition.ROOK, ChessPosition.QUEEN, ChessPosition.KING,
     * ChessPosition.ROOK, ChessPosition.PAWN, ChessPosition.BLANK, 7, 7,
     * ChessPosition.BLANK, ChessPosition.PAWN, ChessPosition.KNIGHT,
     * ChessPosition.BISHOP, ChessPosition.BISHOP, ChessPosition.KNIGHT,
     * ChessPosition.PAWN, ChessPosition.BLANK, 7, 7, ChessPosition.BLANK,
     * ChessPosition.BLANK, ChessPosition.PAWN, ChessPosition.PAWN,
     * ChessPosition.PAWN, ChessPosition.PAWN, ChessPosition.BLANK,
     * ChessPosition.BLANK, 7, 7, ChessPosition.BLANK, ChessPosition.BLANK,
     * ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
     * ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, 7, 7,
     * ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
     * ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
     * ChessPosition.BLANK, ChessPosition.BLANK, 7, 7, ChessPosition.BLANK,
     * -ChessPosition.BLANK, -ChessPosition.PAWN, -ChessPosition.PAWN,
     * -ChessPosition.PAWN, -ChessPosition.PAWN, -ChessPosition.BLANK,
     * ChessPosition.BLANK, 7, 7, ChessPosition.PAWN, -ChessPosition.PAWN,
     * -ChessPosition.KNIGHT, -ChessPosition.BISHOP, -ChessPosition.BISHOP,
     * -ChessPosition.KNIGHT, -ChessPosition.PAWN, ChessPosition.BLANK, 7, 7,
     * ChessPosition.BLANK, -ChessPosition.PAWN, -ChessPosition.ROOK,
     * -ChessPosition.QUEEN, -ChessPosition.KING, -ChessPosition.ROOK,
     * -ChessPosition.PAWN, ChessPosition.BLANK, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7,
     * 7, 7, 7, 7, 7, 7, 7, 7
     * 
     * };
     */
    private static int[] testBoard = { 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7, 7,
            ChessPosition.BLANK, ChessPosition.KING, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, 7, 7, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, 7, 7, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, 7, 7, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, 7,
            7, ChessPosition.BLANK, ChessPosition.ROOK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, 7, 7, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.ROOK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, -ChessPosition.ROOK, 7, 7, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            -ChessPosition.KING, 7, 7, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK,
            ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, ChessPosition.BLANK, 7,
