...
public class ChessPosition extends Position implements Serializable /*throws Exception*/ {
    ...
    public String toString() {
        ...
        sb.append("" + c.check(this, Chess.HUMAN) + c.checkMate(this, Chess.HUMAN) + "/" + c.check(this, Chess.PROGRAM) + c.checkMate(this, Chess.PROGRAM) + ":");
        sb.append("[");
...
/*	private String pp(int piece) {
        if (piece == 0) return "ChessPosition.BLANK";
		String color;
        if (piece < 0) color = "-"; else color = "";
        int p = piece; if (p < 0) p = -p;
        switch (p) {
        case PAWN:	 return "" + color + "ChessPosition.PAWN";
        case KNIGHT: return "" + color + "ChessPosition.KNIGHT";
        case BISHOP: return "" + color + "ChessPosition.BISHOP";
        case ROOK:	 return "" + color + "ChessPosition.ROOK";
        case QUEEN:  return "" + color + "ChessPosition.QUEEN";
        case KING:	 return "" + color + "ChessPosition.KING";
        }
        return "7";
    }*/
	 ...
	 *
	 * Use: Player makes move, this finds computer's move FROM 
	 * player's move position
     *
